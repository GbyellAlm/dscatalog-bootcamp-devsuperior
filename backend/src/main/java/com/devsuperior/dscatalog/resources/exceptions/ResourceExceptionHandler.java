...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<ValidationError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		// "e.getBindingResult().getFieldErrors()" acessa a lista de erros do "MethodArgumentNotValidException" (lista interna de erros do 'Bean Validation'). Serve p/ q eu consiga gerar uma lista de erros na mensagem da resposta da requisicao.
		for (FieldError f : e.getBindingResult().getFieldErrors()) {
			// "f.getField()" pega o nome do campo, e "f.getDefaultMessage()" pega a msg de erro do campo.
